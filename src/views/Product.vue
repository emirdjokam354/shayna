                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel :autoplay="true" :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <div class="pt" data-imgbigurl="img/mickey1.jpg" @click="changeActive(thumbs[0])" :class="thumbs[0] == gambar_default ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" data-imgbigurl="img/mickey2.jpg" @click="changeActive(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active' : '' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" data-imgbigurl="img/mickey3.jpg" @click="changeActive(thumbs[2])" :class="thumbs[2] == gambar_default ? 'active' : '' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" data-imgbigurl="img/mickey4.jpg" @click="changeActive(thumbs[3])" :class="thumbs[3] == gambar_default ? 'active' : '' ">
...
export default {
    ...
    methods: {
        changeActive(urlActive) {
            this.gambar_default = urlActive
        }
    }
}
</script>
